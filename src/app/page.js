...
import Slider from "@/app/(Home page Components)/Slider";
            ...
            <div className="bg-[#FFF3F9] w-[753px] h-[300px] px-[34px] py-[40px] flex flex-col justify-center gap-[20px] rounded-[20px]">
              ...
              <div>
                <p className="font-[500] text-[14px] leading-[22px] text-[#BDA2B0]">
                  ...
                  prioritize anyway job due harvest most opportunity didnt. Yet
                  busy any meeting shark light marginalised 4-blocker message.
